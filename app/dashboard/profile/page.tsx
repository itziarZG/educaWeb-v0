  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-5xl mx-auto pb-20">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex bg-white dark:bg-dark-surface p-1 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800">
          <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white dark:bg-dark-surface rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col items-center gap-6 h-fit">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          {/* Customization Card */}
          <div className="bg-white dark:bg-dark-surface rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <textarea
                  className="w-full p-4 rounded-xl bg-background-light dark:bg-background-dark border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-primary focus:border-transparent min-h-[120px] resize-none"
              ...
              <div>
                ...
                <div className="relative">
                  <select className="w-full p-4 rounded-xl bg-background-light dark:bg-background-dark border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-primary focus:border-transparent appearance-none">

...
export async function POST(request) {
  try {
    ...
    const response = await fetch("https://api.pickaxe.example/generate", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${process.env.PICKAXE_API_KEY}`, // Necesitarías configurar esta variable de entorno
      },

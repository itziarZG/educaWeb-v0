    ...
    <article className="max-w-3xl mx-auto px-4 py-16 space-y-10">
      ...
      <section className="space-y-4">
        ...
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          titular no será responsable de daños directos, indirectos, incidentales
      ...
      <section className="space-y-4">
        ...
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          servicio, total o parcialmente, en cualquier momento. Asimismo, podemos
          actualizar estos Términos y Condiciones. Los cambios significativos se
          comunicarán por correo electrónico o mediante aviso en la plataforma.
          El uso continuado tras la notificación implica la aceptación de los
          nuevos términos.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          usuario, salvo que la normativa vigente disponga otro fuero.
        </p>
      </section>

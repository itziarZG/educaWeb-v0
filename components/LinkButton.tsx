    ...
    <Link
      ...
      className={
        variant === 'big'
          ...
          : 'bg-primary hover:bg-primary/90 text-[#111813] px-2 py-1 rounded-xl text-lg font-bold transition-all shadow-lg shadow-primary/20 flex items-center justify-center gap-2'
      }
    >
      {children}
    </Link>
